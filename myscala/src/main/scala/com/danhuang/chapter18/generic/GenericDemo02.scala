...
import com.danhuang.chapter18.generic.SeasonEnum
import com.danhuang.chapter18.generic.SeasonEnum.SeasonEnum
object GenericDemo02 {
  def main(args: Array[String]): Unit = {
    //使用
    val class01 =
      new EnglishClass[SeasonEnum.SeasonEnum,String,String](SeasonEnum.spring,"0705","高级版")
    println("class01"+class01.classSesaon+" "+class01.className+" "+class01.classType)
    val class02 =
      new EnglishClass[SeasonEnum,String,Int](SeasonEnum.spring,"0705",1)
    println("class01"+class02.classSesaon+" "+class02.className+" "+class02.classType)
  }
}
/*
Scala泛型应用案例2
